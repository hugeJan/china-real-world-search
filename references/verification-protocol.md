...
The purpose is not bureaucracy. It prevents a search result snippet, repost, or later summary from masquerading as the original event record.
...
7. revision/correction chronology.
...
## 11. Government-information request as fallback
